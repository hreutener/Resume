...
# Walk through a DFA to create a random gramatically correct sentence
# Change the lists to add or subtract options for the sentence
...
# Create and print out 100 sentences
for i in range(100):
